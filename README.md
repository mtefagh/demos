...
<p align="center"> توضیح مختصر روش استفاده شده
    <br> 
</p>
...
پیشنهادهایی که موفق به پیاده‌سازی آن نشدید ولی در آینده بر پایه همین کد فعلی قابل پیاده‌سازی می‌باشند
...
لیست تمام زبان‌های برنامه‌نویسی، پکیج‌ها و کتاب‌خانه‌های مورد استفاده
